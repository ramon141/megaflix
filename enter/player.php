...
?>>
        ...
        <div style="position: absolute;left:10px;"><button onclick="pularEpisodio()">Pular Episódio</button></div>
...
<?php echo $nomeEpisodio; ?>
          ...
          <button data-plyr="speed" type="button" role="menuitemradio" id="v5" class="plyr__control" aria-checked="false" value="2" onclick="document.getElementById('v1').setAttribute('aria-checked','false');document.getElementById('v2').setAttribute('aria-checked','false');document.getElementById('v3').setAttribute('aria-checked','false');document.getElementById('v4').setAttribute('aria-checked','false');document.getElementById('v5').setAttribute('aria-checked','false');this.setAttribute('aria-checked','true');document.getElementById('player').playbackRate = 2;">
          <span>2×</span>
          </button>
          ...
          <div role="menu">
          <button data-plyr="speed" type="button" role="menuitemradio" id="l1" class="plyr__control" aria-checked="true" value="0.5" onclick="document.getElementById('l1').setAttribute('aria-checked','false');document.getElementById('l2').setAttribute('aria-checked','false');this.setAttribute('aria-checked','true');"><span>Dublado</span></button>
          <button data-plyr="speed" type="button" role="menuitemradio" id="l2" class="plyr__control" aria-checked="false" value="0.75" onclick="document.getElementById('l1').setAttribute('aria-checked','false');document.getElementById('l2').setAttribute('aria-checked','false');this.setAttribute('aria-checked','true');"><span>Legendado</span></button>
